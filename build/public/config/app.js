...
(function () {
    angular.module('forageApp', ['ui.router']).config(['$stateProvider', '$urlRouterProvider', config]);
    ...
    function config($stateProvider, $urlRouterProvider) {
        $stateProvider.state('signup', {
            ...
            controllerAs: 'home',
            resolve: {
                currentFoodtruck: function currentFoodtruck(FoodtruckService) {
                ...
                currentUser: function currentUser(HomeService) {
