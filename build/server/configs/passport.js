...
module.exports = function (passport) {
    ...
    passport.use(new _passportFacebook.Strategy({
        clientID: ENV['FACEBOOK_CLIENT_ID'] || _auth.facebookAuth.clientID,
        clientSecret: ENV['FACEBOOK_CLIENT_SECRET'] || _auth.facebookAuth.clientSecret,
        callbackURL: ENV['FACEBOOK_CALLBACK_URL'] || _auth.facebookAuth.callbackURL,
